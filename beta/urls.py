...
urlpatterns = [
    ...
    url(r'^sightnext-digest/',include('topics.urls')),
    url(r'^vendor-admin/',include('Vendor.urls')),
    url(r'^$',home.views.Home, name="home"),
    url(r'^mail$',home.views.mailcheck, name="mail"),
    ...
    url(r'^account$', home.views.account, name="account"),
    url(r'^terms-and-conditions$', home.views.termcond, name="terms"),
